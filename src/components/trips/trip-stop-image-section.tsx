  ...
  return (
    <ManagedImageSection
      ...
      messages={{
        ...
        preparationProgress: (current, total) => commonT("preparationProgress", { current, total }),
        uploadProgress: (completed, total) => commonT("uploadProgress", { completed, total }),
        stage: (stage) => commonT(`stages.${stage}`),
        queuePaused: commonT("queuePaused"),
        retryUpload: commonT("retryUpload"),
        keepPageOpen: commonT("keepPageOpen"),
