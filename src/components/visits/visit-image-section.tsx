  ...
  return (
    <ManagedImageSection
      ...
      messages={{
        ...
        preparationProgress: (current, total) => t("preparationProgress", { current, total }),
        uploadProgress: (completed, total) => t("uploadProgress", { completed, total }),
        stage: (stage) => t(`stages.${stage}`),
        queuePaused: t("queuePaused"),
        retryUpload: t("retryUpload"),
        keepPageOpen: t("keepPageOpen"),
